...
export function AboutPage() {
  ...
  return (
    <div className="container-page max-w-prose">
      ...
      <p className="mt-2 text-muted">{t('about.what')}</p>

      <h2 className="mt-8 text-xl">{t('about.whoHeading')}</h2>
      <p className="mt-2 text-muted">{t('about.who')}</p>

      <h2 className="mt-8 text-xl">{t('about.sourcesHeading')}</h2>
      <p className="mt-2 text-muted">{t('about.sources1')}</p>
      <p className="mt-3 text-muted">{t('about.sources2')}</p>

      <h2 className="mt-8 text-xl">{t('about.limitsHeading')}</h2>
      <p className="mt-2 text-muted">{t('about.limits')}</p>
